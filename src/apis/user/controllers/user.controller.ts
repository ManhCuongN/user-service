...
export class UserController extends BaseController<UserEntity>(UserEntity, 'user') {
	...
	async getListOrder(@Res() res, @Req() req) {
		const apiUrl = 'https://api-gateway-production-187c.up.railway.app/api/s3/get-list-order';
	...
	async getListOrderByShop(@Res() res, @Req() req) {
		...
		const apiUrl = 'https://api-gateway-production-187c.up.railway.app/api/s3/get-list-order-by-shop';
